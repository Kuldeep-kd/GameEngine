...
namespace Engine
{
	...
	World::World(Vector2f NewBounds) : Bounds(NewBounds)
	{
	...
	*/
	...
	void World::CalcPosition(Entity* entity)
	{
		...
		*entity->Position += *entity->Velocity * Delta * (ScreenResolution / 10); //1920/10 is actually screen resolution / length in meters you assume your world is being represented on screen
